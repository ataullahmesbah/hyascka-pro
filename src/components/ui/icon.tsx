import {
  ...
  Newspaper, Palette, PenSquare, PieChart, Plug, Quote, Receipt, Rocket, ScrollText, Search,
...
const REGISTRY: Record<string, React.ComponentType<LucideProps>> = {
  ...
  MousePointerClick, Newspaper, Palette, PenSquare, PieChart, Plug, Quote, Receipt, Rocket,
