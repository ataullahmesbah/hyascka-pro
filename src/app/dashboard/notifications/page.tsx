      ...
      <div className="mb-5 flex gap-2">
        <Link
          ...
          className={cn(
            ...
            !unreadOnly ? "border-primary bg-primary-soft text-primary" : "border-border hover:bg-muted",
          )}
        >
          All
        </Link>
              ...
              {notifications.map((notification) => (
                <li key={notification.id}>
                  <Link
                    ...
                    className={cn(
                      "-mx-2 flex items-start gap-3 rounded-lg px-2 py-4 transition-colors hover:bg-muted/60",
                      !notification.read && "bg-primary-soft/35",
                    )}
                  >
                    <span
                      className={cn(
