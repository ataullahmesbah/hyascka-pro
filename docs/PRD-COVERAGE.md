...
| 32 | Testing strategy | `tests/smoke.mjs` (E2E + authorization), `tests/lifecycle.mjs` (request → ticket → invoice), `tests/portal.mjs` (enquiry → quote → invoice, user management); see gaps below |
